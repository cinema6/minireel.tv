...
// envato upgrader class
require_once ( MARS_THEME_DIR . '/includes/class-envato-wordpress-theme-upgrader.php');
//------------------------------ End Image Size -----------------------------------------//
...
if( !function_exists('mars_enqueue_scripts') ){
	function mars_enqueue_scripts() {
		...
		wp_enqueue_script('bootstrap.min.js', '//maxcdn.bootstrapcdn.com/bootstrap/3.2.0/js/bootstrap.min.js');
		wp_enqueue_script('mars-jquery.placeholder.js', MARS_THEME_URI . '/assets/js/ie8/jquery.placeholder.js', array(), '', true);
		//wp_enqueue_script('jquery.fitvids.js', MARS_THEME_URI . '/assets/js/jquery.fitvids.js', array(), '', true);
		...
		wp_enqueue_style('bootstrap.min.css', '//maxcdn.bootstrapcdn.com/bootstrap/3.2.0/css/bootstrap.min.css');
		wp_enqueue_style('mars-netdna.bootstrapcdn.com-font-awesome.css','//netdna.bootstrapcdn.com/font-awesome/4.1.0/css/font-awesome.css');	
