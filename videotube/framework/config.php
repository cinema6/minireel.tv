...
if (!class_exists("Redux_Framework_config")) {
    ...
    class Redux_Framework_config {
        ...
        public function setSections() {
				...
				'fields'	=>	array(
                   ...
                   array(
					...
					array(
						'id' => 'video_feed',
						'type' => 'checkbox',
						'title'	=>	__('Video Feed','mars'),
						'description'	=>	__('Including the Video in Feed Page.','mars')
					),	
					array(
						'id' => 'video_search',
						'type' => 'checkbox',
						'title'	=>	__('Video Search','mars'),
						'description'	=>	__('Only display the Video in Search result page.','mars')
					),
                    array(
                        'id' => 'datetime_format',
                        'type' => 'button_set',
            ...
            $this->sections[] = array(
                ...
                'fields' => array(
                	...
                	array(
                		...
                		'desc'	=>	__('This style will be lost if you reset the settings.','mars'),
                		'mode' => 'css',
                		'theme' => 'monokai',
                		'indent'    => false,
			...
			$this->sections[]	=	array(
				'title'	=>	__('Update','mars'),
				'icon'	=>	'el-icon-cogs',
				'desc'	=>	__('Provide the Username and API key to receive the automatic update.','mars'),
				'fields'	=>	array(
					array(
						'id'	=>	'username',
						'type'	=>	'text',
						'title'	=>	__('Username','mars'),
						'desc'	=>	__('Your Themeforest\'s Username','mars'),
					),
					array(
						'id'	=>	'api',
						'type'	=>	'text',
						'title' => __('API Key','mars'),
						'desc'	=>	__('Your Themeforest\'s API key','mars'),
					)
				)
			);			
        }
