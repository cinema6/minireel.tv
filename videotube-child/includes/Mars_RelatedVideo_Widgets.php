...
if( !function_exists('Mars_RelatedVideos_Widgets') ){
	function Mars_RelatedVideos_Widgets() {
		register_widget('C6_Mars_RelatedVideos_Widgets_Class');
	}
	add_action('widgets_init', 'Mars_RelatedVideos_Widgets');
}

require_once(get_template_directory().'/includes/Mars_RelatedVideo_Widgets.php');

class C6_Mars_RelatedVideos_Widgets_Class extends Mars_RelatedVideos_Widgets_Class{
