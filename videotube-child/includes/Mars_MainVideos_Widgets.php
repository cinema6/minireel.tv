...
if( !function_exists('Mars_MainVideos_Widgets') ){
	function Mars_MainVideos_Widgets() {
		register_widget('C6_Mars_MainVideos_Widgets_Class');
	}
	add_action('widgets_init', 'Mars_MainVideos_Widgets');
}
// require the original class definition from parent theme directory
require_once(get_template_directory().'/includes/Mars_MainVideos_Widgets.php');

class C6_Mars_MainVideos_Widgets_Class extends Mars_MainVideos_Widgets_Class {
			                     ...
			                     <div class="carousel-inner">
			                       	...
			                       	if( $wp_query->have_posts() ) : 
				                       	...
				                       	<?php if( $i == 1 ):?>
				                       		<div class="item active">
				                       	<?php endif;?>	
				                       		<div id="video-main-<?php print $this->id; ?>-<?php the_ID();?>" class="col-sm-<?php print $class_columns;?> col-xs-6 item video-<?php print get_the_ID();?>">
				                                <div class="item-img">
													<?php 
														if(has_post_thumbnail()){
