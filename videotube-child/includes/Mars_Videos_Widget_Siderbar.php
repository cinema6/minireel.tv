...
if( !function_exists('Mars_Videos_Widget_Siderbar') ){
	function Mars_Videos_Widget_Siderbar() {
		register_widget('C6_Mars_Videos_Widget_Siderbar_Class');
	}
	add_action('widgets_init', 'Mars_Videos_Widget_Siderbar');
}

require_once(get_template_directory().'/includes/Mars_Videos_Widget_Siderbar.php');

class C6_Mars_Videos_Widget_Siderbar_Class extends Mars_Videos_Widget_Siderbar_Class{
