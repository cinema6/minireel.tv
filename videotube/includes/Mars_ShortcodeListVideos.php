			...
			if( $wpquery->have_posts() ):
				if( $type == 'widget' && $carousel == 'on' ):	
		                    	...
		                    	<div class="row">
			                     <div class="carousel-inner">
			                       	...
			                       	if( $wpquery->have_posts() ) : 
				                       	...
				                       	<?php endif;?>	
				                       		<div id="video-<?php the_ID();?>" class="col-sm-<?php print $class_columns;?> col-xs-6 item post video-<?php print get_the_ID();?>">
				                                <div class="item-img">
													<?php 
					...
					if( !empty( $title ) ):
						?>
							<div class="section-header">
								<h3 class="widget-title"><?php print $title;?></h3>
							</div>						
						<?php 
					endif;		
					// default
					?>
					<div class="row columns-<?php print $columns;?> video-section meta-maxwidth-230 <?php print $el_class;?>"> 
						<?php while ( $wpquery->have_posts() ): $wpquery->the_post(); ?>
							<div class="col-sm-<?php print $class_columns;?> col-xs-6 item post">
								<div class="item-img">
									<?php 
									if(has_post_thumbnail()):
